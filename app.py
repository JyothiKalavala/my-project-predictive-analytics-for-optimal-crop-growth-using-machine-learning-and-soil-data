...
#df = pd.read_csv(r"C:\Users\tnvpr\data valley projects for pragathi\other new\Predictive Analytics for Optimal Crop Growth Using Machine Learning and Soil Data\perfect_green_gram_disease_labels.csv")
...
# Convert the scaled data back to DataFrame with feature names
...
# Create a copy and numerically encode the 'Disease' column for correlation
df_for_corr = df.copy()
df_for_corr['Disease'] = df_for_corr['Disease'].astype('category').cat.codes

st.write("### Correlation Heatmap")
fig2, ax = plt.subplots(figsize=(10, 8))
sns.heatmap(df_for_corr.corr(), annot=True, cmap='coolwarm', ax=ax)
